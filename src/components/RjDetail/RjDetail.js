            ...
            <div className="left-side col-xs-12 col-sm-9 col-md-9">
              <div className="row share-bread">
                <div className="bread-box col-md-8">
                  <Breadcrumb category="Our Rjs" title="Samita Rajbhandari" />
                </div>
              ...
              <div className="show-box darkpage-bg">
                <div className="row">
                  ...
                  <div className="left-content col-md-3">
                    ...
                    <div className="item-left">
                      <h1 className="item-title">Catch More Shows</h1>
                      <ul className="item-list presenter-list">
                        <Presentor url={`#!`} title="Ukali Orali Deurali" />
                        <Presentor url={`#!`} title="Bhajan Sangeet" />
                        <Presentor url={`#!`} title="Swasthya Sansar" />
                        <Presentor url={`#!`} title="Tech Knowledge" />
                      </ul>
                    </div>
                  ...
                  <div className="right-content col-md-9">
                    <h1 className="content-title">Biography</h1>
                  ...
                  <div className="col-sm-12 col-md-12 more-inn-section">
                    <h1 className="sections-title">More RJs</h1>
                    <div className="row">
                      <Item
                        url={`/rjDetail`}
                        title="Sangita Rajbhandari"
                        image={Artist1}
                      />
                      <Item
                        url={`/rjDetail`}
                        title="Kalam Raj Dhungana"
                        image={Artist2}
                      />
                      <Item
                        url={`/rjDetail`}
                        title="Bishal Kumar Rai"
                        image={Artist3}
                      />
                    </div>
                  </div>
